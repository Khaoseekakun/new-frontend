                                ...
                                <div className="card">
                                    <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                        <a className="d-block blur-shadow-image">
                                            <img src="https://scontent-bkk1-1.xx.fbcdn.net/v/t39.30808-6/452937107_122115415280378051_2873730260610499871_n.jpg?_nc_cat=105&ccb=1-7&_nc_sid=127cfc&_nc_eui2=AeEVMcZbbB4ti-E8OdfSmjUfy0-oeUtR_RPLT6h5S1H9E4Tc5IYEVsF1sbBIzdLx74EZa-MkKV_GJtlmUV2xItIt&_nc_ohc=W9z_V6jsyuoQ7kNvgFnfkTn&_nc_ht=scontent-bkk1-1.xx&oh=00_AYBM1mSxmV9tkb1Zrq5tgGBTo6ABcj1UbvUgMTBWJXHPwg&oe=66B7A2CC" alt="img-colored-shadow" className="img-fluid border-radius-lg" loading="lazy" />
                                        </a>
                                    </div>
                                    <div className="card-body text-center">
                                        ...
                                        <a href="https://www.youtube.com/@Maprang_Astray" className="btn bg-gradient-info mb-0 mt-3">รับชม</a>
                                    </div>
                                </div>
                            </div>
                        </div>
