                    ...
                    <div className="row">
                        <div className="col">
                            <div className="card box-shadow-xl overflow-hidden mb-5">
                                <div className="row">
                                    <div className="col-lg-5 position-relative bg-cover px-0" style={{ backgroundImage: 'url("../assets/img/maprang2.jpg")' }} loading="lazy">
                                        <div className="z-index-2 text-center d-flex h-100 w-100 d-flex m-auto justify-content-center">
                                            ...
                                            <div className="p-5 ps-sm-8 position-relative text-start my-auto z-index-2">
                                                <h3 className="text-white">ข้อมูลในการติดต่อ</h3>
                                                <p className="text-white opacity-8 mb-4">ติดต่อสอบถามเกี่ยวกับงานของศิลปิน เพื่อร่วมงานด้วยกัน, สปอนเซอร์ และอื่นๆ ที่เกี่ยวข้องกับศิลปินของ Astray Entertainment</p>
                                            ...
                                            <div className="card-body pt-1">
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-12 pe-2 mb-3">
                                                        <div className="input-group input-group-static mb-4">
                                                            <label>ข้อความ</label>
                                                            <textarea name="message" className="form-control" id="message" rows={6} placeholder="โปรดระบุข้อความ" defaultValue={""} />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="row">
